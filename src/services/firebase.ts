 ...
 * Just drop this file in src/services/firebase.ts and use sendNotification anywhere in your code
...
export const sendBulkNotification = async (
  ...
  const promises = userIds.map(userId => sendNotification(userId, title, body, data));
